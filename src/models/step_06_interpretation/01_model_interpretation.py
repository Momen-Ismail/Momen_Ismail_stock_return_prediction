...
def main():
    ...
    best_year = (
        ...
        .rename(
            columns={
                "year": "best_test_year",
                "monthly_mse": "best_test_year_mse",
                "oos_r2": "best_test_year_oos_r2",
            }
        )
    )
    ...
    worst_year = (
        ...
        .rename(
            columns={
                ...
                "monthly_mse": "worst_test_year_mse",
                "oos_r2": "worst_test_year_oos_r2",
            }
        )
    )
    ...
    best_model = interpretation.loc[
        interpretation["rank"].idxmin(),
        "model",
    ]

    worst_model = interpretation.loc[
        interpretation["rank"].idxmax(),
        "model",
    ]
